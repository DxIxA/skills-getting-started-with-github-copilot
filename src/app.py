...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, stroke improvement, and water safety",
        "schedule": "Mondays, Wednesdays, Fridays, 3:00 PM - 4:00 PM",
        "max_participants": 16,
        "participants": ["nina@mergington.edu", "cody@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Club": {
        "description": "Practice scenes, improv, and put on school performances",
